...
if __name__ == "__main__":
    ...
    test5 = [[110, 80, 90, 0], [140, 30, 0, 1], [200, 100, 180, 2], [180, 190, -90, 3], [80, 130, 90, 4], [20, 190, -90, 5]]
    test6 = [[60, 100, -90, 1], [80, 150, 180, 2], [130, 100, 0, 3], [160, 160, -90, 4], [160, 50, 180, 5]]
    test7 = [[20, 190, -90, 1],[70, 130, 90, 2],[160, 170, 180, 3],[200, 100, 180, 4],[140, 30, 0, 5]]
    test8 = [[100, 70, 180, 0], [130, 20, 0, 1], [190, 90, 180, 2], [170, 180, -90, 3], [70, 120, 90, 4], [10, 180, -90, 5]]
    test9 = [[110, 80, 180, 0], [140, 30, 0, 1], [190, 100, 180, 2], [180, 190, -90, 3], [80, 130, 90, 4], [20, 190, -90, 5]]
    wk_simulator_w_obstacles(test9)
