...
import static com.example.mdp_group_39.Home.refreshMessageReceivedNS;
        ...
        exploreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (exploreToggleBtn.getText().equals("TASK 1 START")) {
                    ...
                    Home.printMessage("EXPLORATION"); //send a string "BEGIN" to the RPI
                    // Start timer
        ...
        fastestButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fastestToggleBtn.getText().equals("TASK 2 START")) {
                    ...
                    Home.printMessage("FASTEST_CAR"); //send a string "BEGIN" to the RPI
